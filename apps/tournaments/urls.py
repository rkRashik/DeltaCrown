...
from apps.tournaments.views.hub import (
    ...
    HubRosterAPIView,
    HubSquadAPIView,
    HubSquadPingMissingAPIView,
    HubSquadSetCaptainAPIView,
    HubResourcesAPIView,
...
urlpatterns = [
    ...
    path('<slug:slug>/draw/presets/', smart_group_presets, name='smart_group_presets'),
    ...
    path('<slug:slug>/hub/api/squad/ping-missing/', HubSquadPingMissingAPIView.as_view(), name='hub_squad_ping_missing_api'),
    path('<slug:slug>/hub/api/squad/set-captain/', HubSquadSetCaptainAPIView.as_view(), name='hub_squad_set_captain_api'),
