...
class PaymentVerification(models.Model):
    ...
    verified_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name="payments_verified"
    )
    verified_at = models.DateTimeField(null=True, blank=True)
    
    rejected_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name="payments_rejected"
    )
    rejected_at = models.DateTimeField(null=True, blank=True)
    
    refunded_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name="payments_refunded"
    )
    ...
    def mark_verified(self, user, reason: str = ""):
        ...
        self.save(update_fields=["status", "verified_by", "verified_at", "reject_reason", "last_action_reason", "updated_at"])
