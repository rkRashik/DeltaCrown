...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'digest_date', 'is_sent'], name='notificatio_user_id_7aa35f_idx'),
        ),
