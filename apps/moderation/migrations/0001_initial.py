    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["ref_type", "ref_id", "created_at"], name="mod_audit_ref_idx"
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("ban", "Ban"), ("suspend", "Suspend"), ("mute", "Mute")],
                        max_length=20,
                    ),
                ),
                (
                    "scope",
                    models.CharField(
                        choices=[("global", "Global"), ("tournament", "Tournament")], max_length=20
                    ),
                ),
