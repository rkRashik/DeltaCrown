...
urlpatterns = [
    ...
    path('teams/<str:slug>/available-players/<int:user_id>/invite/', team_manage.invite_available_player, name='team_manage_invite_available_player'),
    ...
    # Team Follow (public)
    path('teams/<str:slug>/follow/', team_manage.toggle_team_follow, name='team_toggle_follow'),
