...
class TeamFactory(DjangoModelFactory):
    ...
    IMPORTANT: Team must have organization XOR owner (not both, not neither).
    ...
    Usage:
        ...
        user = UserFactory()
        team = TeamFactory(organization=None, owner=user)
    ...
    # slug auto-generated by model.save()
    organization = factory.SubFactory(OrganizationFactory)
    owner = None  # Default: organization-owned team (owner=None)
    ...
    def create_independent(cls, **kwargs):
        ...
        """
        owner = kwargs.pop("owner", None) or UserFactory.create()
        return cls.create(organization=None, owner=owner, **kwargs)
