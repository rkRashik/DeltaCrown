        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_id",
                    models.IntegerField(
                        blank=True, help_text="User who triggered the event", null=True
                    ),
                ),
                (
                    "correlation_id",
                ...
                (
                    "retry_count",
                    models.IntegerField(default=0, help_text="Number of processing attempts"),
                ),
                (
                    "last_error",
                    models.TextField(
                        blank=True, help_text="Error message from most recent failure", null=True
                    ),
                ),
                (
                    "last_error_at",
                    models.DateTimeField(
                        blank=True, help_text="Timestamp of most recent error", null=True
                    ),
                ),
            ],
            options={
