        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sku",
                    models.CharField(
                        db_index=True, help_text="Unique item SKU", max_length=100, unique=True
                    ),
                ),
                ...
                (
                    "price",
                    models.IntegerField(
                        help_text="Price in DeltaCoins (must be positive)",
                        validators=[django.core.validators.MinValueValidator(1)],
                    ),
                ),
                (
                    "active",
                    models.BooleanField(default=True, help_text="Item available for purchase"),
                ),
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("price__gt", 0)), name="shop_item_price_positive"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.IntegerField(
                        help_text="Hold amount in DeltaCoins",
                        validators=[django.core.validators.MinValueValidator(1)],
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Expiration timestamp (nullable)", null=True
                    ),
                ),
                (
                    "idempotency_key",
                    models.CharField(
                        blank=True,
                        help_text="Idempotency key (nullable)",
                        max_length=255,
                        null=True,
                    ),
                ),
                (
                    "captured_txn_id",
                    models.IntegerField(
                        blank=True, help_text="DeltaCrownTransaction ID if captured", null=True
                    ),
                ),
                (
                    "meta",
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("amount__gt", 0)), name="shop_hold_amount_positive"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("status__in", ["authorized", "captured", "released", "expired"])
                        ),
