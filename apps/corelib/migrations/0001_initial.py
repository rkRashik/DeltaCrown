...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'scope', 'token'], name='corelib_ide_user_id_d8653e_idx')],
                'constraints': [models.UniqueConstraint(fields=('user', 'scope', 'token'), name='uq_idem_user_scope_token')],
            },
        ),
    ]
