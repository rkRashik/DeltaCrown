...
# Redis fixtures for Module 6.8 moved to root conftest.py (pytest_plugins)


User = get_user_model()


# Model compatibility shims are now applied globally from root conftest.py
# via tests/_model_shims.py. No need to duplicate them here.
