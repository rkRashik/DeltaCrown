...
`;
  ...
  function useTweaks(defaults) {
    ...
    const persist = React.useCallback(merged => {
      try {
        localStorage.setItem('dc-community-tweaks', JSON.stringify(merged));
      } catch (e) {}
      const api = window.DC && window.DC.api;
  ...
  function TweaksPanel({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, __TWEAKS_STYLE), !inDesignHost && !open && /*#__PURE__*/React.createElement("button", {
      className: "dc-tweaks-trigger",
      onClick: () => setOpen(true),
      "aria-label": "Open tweaks"
    }, /*#__PURE__*/React.createElement("i", {
      className: "fa-solid fa-sliders text-xs"
